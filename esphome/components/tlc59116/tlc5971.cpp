...
static const char *const TAG = "tlc59116";
...
void TLC59116::setup() {
  ...
  ESP_LOGCONFIG(TAG, "Done setting up TLC59116 output component.");
}
...
void TLC59116::transfer_(uint8_t send) {
